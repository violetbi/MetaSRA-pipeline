        ...
        for syn in raw_syns:
            ...
            if m:
                ...
                try:
                    syn_parts = syn.split('"')
                    if len(syn_parts) > 2:
                        syn_type = syn_parts[2].strip().split()[0]
                    else:
                        print("Not enough parts after splitting by double quotes")
                except IndexError:
                    print("Index error occurred. Check the format of the input string.")
